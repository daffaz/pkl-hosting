            ...
            <div class="row d-flex">
                <div class="col-lg-6 my-auto">
                    <div class="card1 pb-5">
                        <div class="row px-3 justify-content-center mt-5 mb-5 border-line"> <img src="{{asset('images/forgot.svg')}}" class="image"> </div>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-6 offset-md-4">
                                        <button type="submit" class="btn btn-primary biru-unggulan-button btn-block" >
                                            {{ __('Kirim link lupa password') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
