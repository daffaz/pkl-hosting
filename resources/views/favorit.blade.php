...
@section('title', 'Favorit | Perpustakaan Digital | Maca')
    ...
    <div class="container mt-5 mb-5">
        ...
        <div class="mt-5">
            <div class="text-center montserrat mt-5">
                <h1 style="color: #16325C"><i>E-book</i> favorit</h1>
            </div>
            <div class="row mt-5" style="margin-bottom:200px!important;">
                @if (!$favorit->count())
                    <div class="col-12 text-center">
                        <h5 class="my-5">Data e-book favorit tidak ditemukan</h5>
                    </div>
                @else
                    @foreach ($favorit as $b)
                        <div class="col-lg-8 col-md-12 col-12 mx-auto">
                            <div class="d-flex bg-white align-items-center justify-content-start shadow my-3 w-100">
                                <img src="{{ asset('uploaded/gambar/' . $b->ebook->gambar) }}"  class="gambar-favorit" alt="buku">
                                <div class="pr-lg-5 pr-md-5 d-flex flex-column flex-md-column flex-lg-column flex-fill align-items-lg-start align-items-md-start align-items-center">
                                    <div class="d-flex flex-column p-3" style="color: #16325C">
                                        <div class="home-text-kotak-h5 text-center text-md-left text-lg-left">{{ $b->ebook->penulis }}</div>
                                        <div class="home-text-kotak-h4 text-center text-md-left text-lg-left">{{ $b->ebook->judul }}</div>
                                    </div>
                                    <a class="mt-lg-4 mt-md-5" href="/kategori-ebook/{{ $b->ebook->slug }}">
